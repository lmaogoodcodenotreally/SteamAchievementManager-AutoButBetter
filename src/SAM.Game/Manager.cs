...
namespace SAM.Game
{
    internal partial class Manager : Form
    {
        ...
        private readonly API.UserStatsReceived _UserStatsReceivedCallback;
        ...
        public Manager(long gameId, API.Client client, bool isAuto = false)
        {
            ...
            this._UserStatsReceivedCallback = client.CreateAndRegisterCallback<API.UserStatsReceived>();
        ...
        private void OnUserStatsReceived(SAM.API.Stats.UserStatsResponse param)
        {
        ...
        private void UpdateSteamId()
        {
            try
            {
                ...
                this._SteamIdLabel.Text = $"Steam64: {steamId}";
            }
            catch
            {
                this._SteamIdLabel.Text = "Steam64: Error";
            }
        }
