...
public partial class LibraryTileViewModel : LibraryViewModel
{
    ...
    public LibraryTileViewModel(LibraryTileSettings settings, SteamUser user = null) : base(settings, user)
    {
        Settings = settings;
    ...
    protected void OnShowImagesChanged()
    {
        ...
        // Update the underlying settings with the actual ShowImages value
        _settings.ShowImages = ShowImages;
